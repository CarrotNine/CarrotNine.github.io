<template>
    ...
    <div class="navigation">
        <ul style="list-style:none">
            <li style="float: left;color:orange;">
                <h2>网上商城               </h2>
            </li>
            <hr>
            <li style="float: left">
            ...
            <li v-if="!user">
                <span class="loginSpan"><router-link to="/login" style="color:black;">请登录   
                    <li>   /      </li>
                    
                </router-link><router-link to="/register"><span>没有账户?注册</span></router-link></span>
            </li>
            <li v-else>
