  ...
  <div class="register">
    ...
    <el-form :model="form" status-icon :rules="rules" ref="form" label-width="100px" class="demo-form">
       <el-form-item label="用户名" prop="name">
        <el-input placeholder="输入你的名字" type="text" v-model="form.name" autocomplete="off" ></el-input>
      </el-form-item>
      <el-form-item label="密码" prop="password">
        <el-input placeholder="请设置密码" type="password" v-model="form.password" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item  label="确认密码" prop="checkPass">
        <el-input placeholder="再次输入确认密码" type="password" v-model="form.checkPass" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item  label="电话" prop="phone">
        <el-input placeholder="+86 输入你的电话号码（12位）" type="tel" v-model="form.phone" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item  label="邮箱" prop="email">
        <el-input  placeholder="你的邮箱地址" type="email" v-model="form.email" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item  label="城市" prop="city">
        <el-input placeholder="你所在的城市，如：湘潭市" type="text" v-model="form.city" autocomplete="off"></el-input>
      </el-form-item>
      ...
      <el-form-item  label="银行卡号" prop="card">
        <el-input placeholder="你的银行卡号码（16位）" type="tel" v-model="form.card" autocomplete="off"></el-input>
      </el-form-item>
    ...
    <div class="toMerchantRegister"><router-link to="/sellRegister" style="color: purple;">&gt;<b>商家注册</b></router-link></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    draw() {
        var context = this.$refs.canvas.getContext("2d");//幕布，getContext() 方法可返回一个对象，该对象提供了用于在画布上绘图的方法和属性。
